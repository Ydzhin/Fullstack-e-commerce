<template>
  <div class="auth">
    <div v-if="action === 'register'" class="register">
      ...
      <forminput
        class="login_input"
        :svg_value="inputs.register.firstname.svg"
      ...
      <forminput
        ...
        :svg_value="inputs.register.lastname.svg"
      ...
      <forminput
        class="register_input"
        :svg_value="inputs.register.email.svg"
        :placeholder="inputs.register.email.placeholder"
        :type="inputs.register.email.type"
      >
      </forminput>
      <forminput
        class="register_input"
        :svg_value="inputs.register.telephone.svg"
      ...
      <forminput
        class="register_input"
        :svg_value="inputs.register.addresse.svg"
      ...
      <forminput
        class="register_input"
        :svg_value="inputs.register.code.svg"
        :placeholder="inputs.register.code.placeholder"
        :type="inputs.register.code.type"
      >
      </forminput>
      <forminput
        class="register_input"
        :svg_value="inputs.register.complement.svg"
      ...
      <forminput
        class="register_input"
        :svg_value="inputs.register.password.svg"
      ...
      <forminput
        class="register_input"
        :svg_value="inputs.register.confirmPassword.svg"
    ...
    <form v-if="action === 'login'" :onsubmit="try_login" class="login">
      ...
      <forminput
        class="login_input"
        :svg_value="inputs.login.email.svg"
        :placeholder="inputs.login.email.placeholder"
        :type="inputs.login.email.type"
      >
      </forminput>
      <forminput
        class="login_input"
        :svg_value="inputs.login.password.svg"
        :placeholder="inputs.login.password.placeholder"
        :type="inputs.login.password.type"
      >
      </forminput>
      ...
      <GoogleLogin class="googleLogin" :callback="callback">
        <formbutton class="btnGoogleLogin" :type="'submit'">
          ...
          >
            <path
              d="M10.2426 16.3137L6 12.071L7.41421 10.6568L10.2426 13.4853L15.8995 7.8284L17.3137 9.242"
              fill="white"
            />
          </svg>
      ...
      <small :onclick="() => (action = 'register')">
        I don't have yet an account !
      </small>
    </form>
    <button v-if="action === 'login'" @click="yourLogoutFunction">
      logout
    </button>
...
const try_login = async () => {
  ...
  const data_login = {
    email: inputs[0].childNodes[1].value,
    password: inputs[1].childNodes[1].value,
  };
